...
describe('TeamService', () => {
  ...
  describe('createTeam', () => {
    it('should create a new team', async () => {
      const createTeamDTO: CreateUpdateTeamDTO = {
        name: 'Nhóm 1',
      };
      const saveSpy = jest
      ...
      expect(result).toEqual(plainToClass(CreateUpdateTeamDTO, createTeamDTO));
    });
  ...
  describe('updateTeam', () => {
    it('should update an existing team', async () => {
      const id = 1;
      const updateTeamDTO: CreateUpdateTeamDTO = {
        name: 'Nhóm 1',
      };
      ...
      expect(result).toEqual(plainToClass(CreateUpdateTeamDTO, updateTeamDTO));
    });
